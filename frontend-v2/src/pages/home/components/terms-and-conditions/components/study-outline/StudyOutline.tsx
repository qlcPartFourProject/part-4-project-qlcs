      ...
      >
        <SubSection
          ...
          body={[
            ...
            'We have developed a tool that automatically generates QLCs about a student’s submitted Python code. We aim to test the effectiveness of this tool in facilitating a student’s reflection on their own code.',
          ]}
        />
        <SubSection
